...
class ECG:
    ...
    def peak_detection(self):
        ...
        # signal = self.edit_dataframe()
        signals, _ = nk.ecg_process(self.original_signal.values.flatten(), sampling_rate=500)
        signals, _ = nk.ecg_process(signals['ECG_Clean'][2000:], sampling_rate=500)
        ...
        rr_peaks = nk.ecg_findpeaks(final_signal2, sampling_rate=500)
        
        _, features = nk.ecg_delineate(final_signal2, sampling_rate=500, method='peak')
